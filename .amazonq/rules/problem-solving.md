...
## Quando Não Encontrar Solução Simples
...
### O que fazer:
1. **Identifique o problema real** - não apenas os sintomas
2. **Tente a solução mais simples primeiro**
3. **Se não funcionar, PARE e PERGUNTE:**
...
## Lembre-se:
É melhor perguntar e fazer certo do que assumir e fazer errado.