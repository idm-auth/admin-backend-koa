...
import {
  ...
  ApplicationControllerSymbol,
} from '@/domain/realm/application/application.controller';
import {
  ApplicationMapper,
...
export class ApplicationModule extends AbstractModule {
  protected runBind(): void {
    this.container
      .bind(ApplicationRepositorySymbol)
      .to(ApplicationRepository)
      .inSingletonScope();
    this.container
      .bind(ApplicationMapperSymbol)
      .to(ApplicationMapper)
      .inSingletonScope();
    this.container
      .bind(ApplicationServiceSymbol)
      .to(ApplicationService)
      .inSingletonScope();
    this.container
      .bind(ApplicationControllerSymbol)
