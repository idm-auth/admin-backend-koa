...
import { GroupRoleController, GroupRoleControllerSymbol } from '@/domain/realm/group-role/group-role.controller';
...
export class GroupRoleModule extends AbstractModule {
  protected runBind(): void {
    this.container.bind(GroupRoleRepositorySymbol).to(GroupRoleRepository).inSingletonScope();
    this.container.bind(GroupRoleMapperSymbol).to(GroupRoleMapper).inSingletonScope();
    this.container.bind(GroupRoleServiceSymbol).to(GroupRoleService).inSingletonScope();
    this.container.bind(GroupRoleControllerSymbol).to(GroupRoleController).inSingletonScope();
  }
