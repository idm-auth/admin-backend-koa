...
import { PolicyResourceSchema, policyResourceSchema } from '@/domain/realm/policy-resource/policy-resource.entity';

export const PolicyResourceRepositorySymbol = Symbol.for('PolicyResourceRepository');
