...
import { PolicyResourceDtoTypes, policyResourceBaseResponseSchema } from '@/domain/realm/policy-resource/policy-resource.dto';
...
export class PolicyResourceMapper extends AbstractCrudMapper<PolicyResourceSchema, PolicyResourceDtoTypes> {
  constructor() {
