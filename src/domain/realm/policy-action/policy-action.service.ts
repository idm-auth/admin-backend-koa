...
export class PolicyActionService extends AbstractCrudService<
  PolicyActionSchema,
  PolicyActionDtoTypes,
  PolicyActionCreate
> {
  @inject(PolicyActionRepositorySymbol)
  protected repository!: PolicyActionRepository;
  ...
  protected buildCreateDataFromDto(
    dto: PolicyActionDtoTypes['CreateRequestDto']
  ): PolicyActionCreate {
    return {
  ...
  protected buildUpdate(
    ...
    dto: PolicyActionDtoTypes['UpdateRequestDto']
  ): PolicyActionEntity {
    return entity;
  }
}
