...
import { RolePolicyDtoTypes, rolePolicyBaseResponseSchema } from '@/domain/realm/role-policy/role-policy.dto';
...
export class RolePolicyMapper extends AbstractCrudMapper<RolePolicySchema, RolePolicyDtoTypes> {
  constructor() {
