...
import {
  ...
  RolePolicyControllerSymbol,
} from '@/domain/realm/role-policy/role-policy.controller';
import {
  RolePolicyMapper,
...
export class RolePolicyModule extends AbstractModule {
  protected runBind(): void {
    this.container
      .bind(RolePolicyRepositorySymbol)
      .to(RolePolicyRepository)
      .inSingletonScope();
    this.container
      .bind(RolePolicyMapperSymbol)
      .to(RolePolicyMapper)
      .inSingletonScope();
    this.container
      .bind(RolePolicyServiceSymbol)
      .to(RolePolicyService)
      .inSingletonScope();
    this.container
      .bind(RolePolicyControllerSymbol)
      .to(RolePolicyController)
      .inSingletonScope();
  }
