...
export class AccountRoleService extends AbstractCrudService<
  AccountRoleSchema,
  AccountRoleDtoTypes,
  AccountRoleCreate
> {
  @inject(AccountRoleRepositorySymbol)
  protected repository!: AccountRoleRepository;
  ...
  protected buildCreateDataFromDto(
    dto: AccountRoleDtoTypes['CreateRequestDto']
  ): AccountRoleCreate {
    return {
  ...
  protected buildUpdate(
    entity: AccountRoleEntity,
    dto: AccountRoleDtoTypes['UpdateRequestDto']
  ): AccountRoleEntity {
    return entity;
  }
}
