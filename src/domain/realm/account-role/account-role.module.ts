...
import { AccountRoleController, AccountRoleControllerSymbol } from '@/domain/realm/account-role/account-role.controller';
...
export class AccountRoleModule extends AbstractModule {
  protected runBind(): void {
    this.container.bind(AccountRoleRepositorySymbol).to(AccountRoleRepository).inSingletonScope();
    this.container.bind(AccountRoleMapperSymbol).to(AccountRoleMapper).inSingletonScope();
    this.container.bind(AccountRoleServiceSymbol).to(AccountRoleService).inSingletonScope();
    this.container.bind(AccountRoleControllerSymbol).to(AccountRoleController).inSingletonScope();
  }
