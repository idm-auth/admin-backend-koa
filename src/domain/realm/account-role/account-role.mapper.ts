...
import { AccountRoleDtoTypes, accountRoleBaseResponseSchema } from '@/domain/realm/account-role/account-role.dto';
...
export class AccountRoleMapper extends AbstractCrudMapper<AccountRoleSchema, AccountRoleDtoTypes> {
  constructor() {
