...
export const ApplicationConfigurationRepositorySymbol = Symbol.for('ApplicationConfigurationRepository');
...
export class ApplicationConfigurationRepository extends AbstractCrudMongoRepository<ApplicationConfigurationSchema> {
  constructor() {
    super(applicationConfigurationSchema, 'application-configurations');
  }
