...
import { SystemSetupController, SystemSetupControllerSymbol } from '@/domain/realm/system-setup/system-setup.controller';
import { SystemSetupMapper, SystemSetupMapperSymbol } from '@/domain/realm/system-setup/system-setup.mapper';
import { SystemSetupRepository, SystemSetupRepositorySymbol } from '@/domain/realm/system-setup/system-setup.repository';
