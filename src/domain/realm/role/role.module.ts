...
import { RoleController, RoleControllerSymbol } from '@/domain/realm/role/role.controller';
...
export class RoleModule extends AbstractModule {
  protected runBind(): void {
    this.container.bind(RoleRepositorySymbol).to(RoleRepository).inSingletonScope();
    ...
    this.container.bind(RoleControllerSymbol).to(RoleController).inSingletonScope();
  }
