...
import { ApplicationActionDtoTypes, applicationActionBaseResponseSchema } from '@/domain/realm/application-action/application-action.dto';
import { ApplicationActionSchema } from '@/domain/realm/application-action/application-action.entity';

export const ApplicationActionMapperSymbol = Symbol.for('ApplicationActionMapper');

@Mapper(ApplicationActionMapperSymbol)
export class ApplicationActionMapper extends AbstractCrudMapper<ApplicationActionSchema, ApplicationActionDtoTypes> {
  constructor() {
