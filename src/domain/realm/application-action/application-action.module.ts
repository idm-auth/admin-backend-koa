...
import {
  ...
  ApplicationActionControllerSymbol,
} from '@/domain/realm/application-action/application-action.controller';
import {
...
export class ApplicationActionModule extends AbstractModule {
  protected runBind(): void {
    this.container
      .bind(ApplicationActionRepositorySymbol)
      .to(ApplicationActionRepository)
      .inSingletonScope();
    this.container
      .bind(ApplicationActionMapperSymbol)
      .to(ApplicationActionMapper)
      .inSingletonScope();
    this.container
      .bind(ApplicationActionServiceSymbol)
      .to(ApplicationActionService)
      .inSingletonScope();
    this.container
      .bind(ApplicationActionControllerSymbol)
      .to(ApplicationActionController)
      .inSingletonScope();
  }
