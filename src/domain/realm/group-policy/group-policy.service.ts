...
export class GroupPolicyService extends AbstractCrudService<
  GroupPolicySchema,
  GroupPolicyDtoTypes,
  GroupPolicyCreate
> {
  @inject(GroupPolicyRepositorySymbol)
  protected repository!: GroupPolicyRepository;
  ...
  protected buildCreateDataFromDto(
    dto: GroupPolicyDtoTypes['CreateRequestDto']
  ): GroupPolicyCreate {
    return {
      groupId: dto.groupId,
  ...
  protected buildUpdate(
    entity: GroupPolicyEntity,
    dto: GroupPolicyDtoTypes['UpdateRequestDto']
  ): GroupPolicyEntity {
    return entity;
  }
}
