...
import { RealmController, RealmControllerSymbol } from '@/domain/core/realm/realm.controller';
...
export class RealmModule extends AbstractModule {
  ...
  protected runBind(): void {
    this.container.bind(RealmRepositorySymbol).to(RealmRepository).inSingletonScope();
    ...
    this.container.bind(RealmControllerSymbol).to(RealmController).inSingletonScope();
  }
