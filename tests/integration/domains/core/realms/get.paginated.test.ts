...
describe('GET /api/core/realms (paginated)', () => {
  ...
  afterAll(async () => {
    ...
    for (const id of createdRealmIds) {
      await request(getApp().callback()).delete(`/api/core/realms/${id}`);
    }
  });
  ...
  it('should return correct page 2 with smaller limit', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?page=2&limit=10')
      .expect(200);
  ...
  it('should return correct page 3 with limit 5', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?page=3&limit=5')
      .expect(200);
  ...
  it('should filter realms by name pattern', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?filter=test-realm')
      .expect(200);
  ...
  it('should sort realms by name ascending', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?sortBy=name&descending=false&limit=10')
      .expect(200);
  ...
  it('should sort realms by name descending', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?sortBy=name&descending=true&limit=10')
      .expect(200);
  ...
  it('should handle pagination with filter and sort', async () => {
    const response = await request(getApp().callback())
      .get(
        '/api/core/realms?filter=test-realm&sortBy=name&descending=false&page=1&limit=5'
      )
      .expect(200);
  ...
  it('should return empty page when page exceeds total pages', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?page=999&limit=10')
      .expect(200);
  ...
  it('should handle descending=1 as true', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?sortBy=name&descending=1&limit=5')
      .expect(200);
  ...
  it('should handle descending=0 as false', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?sortBy=name&descending=0&limit=5')
      .expect(200);
  ...
  it('should handle descending=yes as true', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?sortBy=name&descending=yes&limit=5')
      .expect(200);
  ...
  it('should handle descending=no as false', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?sortBy=name&descending=no&limit=5')
      .expect(200);
  ...
  it('should use default descending=false when parameter is omitted', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?sortBy=name&limit=5')
      .expect(200);
  ...
  it('should handle string numbers for page and limit parameters', async () => {
    const response = await request(getApp().callback())
      .get('/api/core/realms?page=2&limit=5')
      .expect(200);
